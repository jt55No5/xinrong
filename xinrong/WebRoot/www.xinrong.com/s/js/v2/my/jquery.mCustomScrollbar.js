...
(function(b, a, c) { (function(d) {
        ...
        i = {
            ...
            _draggable: function() {
                ...
                y,
                z;
                w.bind("mousedown." + r + " touchstart." + r + " pointerdown." + r + " MSPointerDown." + r,
                function(E) {
                ...
                j(a).bind("mousemove." + r + " pointermove." + r + " MSPointerMove." + r,
                function(C) {
                    if (A) {
                        var D = A.offset(),
                        E = i._coordinates(C)[0] - D.top,
                ...
                }).add(w).bind("mouseup." + r + " touchend." + r + " pointerup." + r + " MSPointerUp." + r,
                function(B) {
                    if (A) {
                        i._onDragClasses(A, "active", p.autoExpandScrollbar);
                        A = null
            ...
            _contentDraggable: function() {
                ...
                z.bind("touchstart." + F + " pointerdown." + F + " MSPointerDown." + F,
                function(N) {
                ...
                }).bind("touchmove." + F + " pointermove." + F + " MSPointerMove." + F,
                function(Q) {
                ...
                v.bind("touchstart." + F + " pointerdown." + F + " MSPointerDown." + F,
                function(N) {
                    if (!i._pointerTouch(N) || n) {
                        return
                    }
                    ...
                    C = [];
                    D = []
                }).bind("touchend." + F + " pointerup." + F + " MSPointerUp." + F,
                function(P) {
            ...
            _draggerRail: function() {
                ...
                p.bind("touchstart." + q + " pointerdown." + q + " MSPointerDown." + q,
                function(v) {
                    n = true
                }).bind("touchend." + q + " pointerup." + q + " MSPointerUp." + q,
                function(v) {
                    n = false
                }).bind("click." + q,
                function(z) {
            ...
            _buttons: function() {
                ...
                q = j(s + ">a");
                q.bind("mousedown." + r + " touchstart." + r + " pointerdown." + r + " MSPointerDown." + r + " mouseup." + r + " touchend." + r + " pointerup." + r + " MSPointerUp." + r + " mouseout." + r + " pointerout." + r + " MSPointerOut." + r + " click." + r,
                function(z) {
                    z.preventDefault();
            ...
            _keyboard: function() {
                ...
                r.attr("tabindex", "0").bind("blur." + s + " keydown." + s + " keyup." + s,
                function(D) {
                    switch (D.type) {
                    case "blur":
