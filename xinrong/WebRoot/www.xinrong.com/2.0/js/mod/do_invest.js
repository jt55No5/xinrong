		  	      					...
		  	      					$.ajax({
	  	      							...
	  	      							success:function(result){
	  	      								...
	  	      								if(result.state==0){
		  	      								...
		  	      								var contents ;
	  	      									if (_reward!=0) {
	  	      										contents ='<p style="margin-top: 10px;">投资金额：'+_d.money +'元<a href="/my/invest" target="_black" class="blue" style="margin-left:25px">查看投资详情></a></p>' 
													+'<p style="margin-top: 10px;">到期本息：'+ _d.earn + '元，回款日期：'+rTime+'，计息时长：'+p_time+'</p>'
