        	...
        	<form class="form-signin">
	      	...
	      	<div class="row">
	      		<div class="col-md-4 col-md-offset-4">
	      			<h2 class="form-signin-heading">添加后台用户</h2>
	      	...
	      	<div class="row">
	      		...
	      		<div class="col-md-4">
	        		...
	        		<input type="text" name="accountNumber" id="inputAccountNumber" class="form-control" placeholder="请输入账号" required autofocus>
	        	</div>
	      	</div>
	      	
	      	<div class="row">
	      		<div class="col-md-1 col-md-offset-3"><p class="form-control-static">密码</p></div>
	      		<div class="col-md-4">
	      	...
	      	<div class="row">
	      		...
	      		<div class="col-md-4">
	        		...
	        		<input type="password" name="repassword" id="inputRePassword" class="form-control" placeholder="请再次输入密码" required>
	        	</div>
	      	</div>
	      	...
	      	<div class="row">
	      		...
	      		<div class="col-md-4">
	        		...
	        		<input type="text" name="username" id="inputUsername" class="form-control" placeholder="请输入姓名" required autofocus>
	        	</div>
	      	</div>
	      	...
	      	<div class="row">
	      		...
	      		<div class="col-md-4">
	        		...
	        		<input type="text" name="jobNo" id="inputJobNo" class="form-control" placeholder="请输入工号" required autofocus>
	        	</div>
	      	</div>
	      	
	      	<div class="row">
	      		<div class="col-md-1 col-md-offset-3"><p class="rpwd form-control-static">用户类型</p></div>
	      		<div class="col-md-4">
