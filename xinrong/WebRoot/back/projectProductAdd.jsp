        	...
        	<form class="form-signin">
	      	...
	      	<div class="row">
	      		<div class="col-md-4 col-md-offset-4">
	      			<h2 class="form-signin-heading">新增项目系列</h2>
	      	...
	      	<div class="row">
	      		...
	      		<div class="col-md-4">
	        		...
	        		<input type="text" name="productName" id="productName" class="form-control" placeholder="请输入系列名称" required autofocus>
	        	</div>
	      	</div>
	      	...
	      	<div class="row">
	      		...
	      		<div class="col-md-4">
	        		...
	        		<input type="text" name="day" id="day" class="form-control" placeholder="请输入融资期限" required>
	        	</div>
	      	</div>
	      	...
	      	<div class="row">
	      		...
	      		<div class="col-md-4">
	        		...
	        		<input type="text" name="money" id="money" class="form-control" placeholder="请输入融资金额" required>
	        	</div>
	      	</div>
	      	
	      	<div class="row">
	      		<div class="col-md-1 col-md-offset-3"><p class="form-control-static">预期年化收益率</p></div>
	      		<div class="col-md-4">
	      			 <label for="inputUsername" class="sr-only">预期年化收益率</label>
	        		<input type="text" name="username" id="inputUsername" class="form-control" placeholder="请输入预期年化收益率" required autofocus>
	        	</div>
	      	</div>
