        	...
        	<form class="form-signin">
	      		<div class="row">
		      		<div class="col-md-4 col-md-offset-4">
		      			<h2 class="form-signin-heading">审核记录</h2>
		      		</div>
		      	</div>
	      		
	      		<div class="row">
		      		<div class="col-md-2 col-md-offset-1">
		      			 <label for="inputProname" class="sr-only">项目名称</label>
		        		<input type="text" name="proname" id="inputProname" class="form-control" placeholder="请输入项目名" required autofocus>
		        	</div>
	      	...
	      	<div class="row">
	      			...
	      			<table class="table table-striped table-bordered">
	      				...
	      				<tr>
	      					...
	      					<td>xxx</td>
	      					<td>2017-10-01</td>
	      					<td><a href="javascript:;">刘文勇</a>&nbsp;<a href="javascript:;"></a></td>
	      					<td>通过</td>
	      				</tr>
	      				<tr>
	      					<td>信·优企贷</td>
	      					<td>马云</td>
	      					<td>2017-01-01</td>
	      					<td><a href="javascript:;">张三</a>&nbsp;<a href="javascript:;"></a></td>
	      					<td>未通过</td>
	      				</tr>
	      			</table>
